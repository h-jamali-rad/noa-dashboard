...
const phaseDefs = [
  { id: 1, slug: 'preprocessing', title: 'Agent 1 — Data Preprocessing', subtitle: '2,413 patients • 73 features (55+18) • 18 pathology features', description: 'Clinical cohort ingestion, pathology feature extraction, and leakage-safe preprocessing for NOA micro-TESE prediction.', objectives: ['Ingest and quality-check source records', 'Construct analytical cohort', 'Engineer and validate pathology-aware feature set', 'Implement leakage-safe preprocessing'], deliverables: ['Leakage-safe preprocessing pipeline', 'Dataset with 73 features (55 original + 18 engineered pathology)', 'Data quality and missingness documentation'], iconKey: 'database', accent: '#0f6d8b' },
