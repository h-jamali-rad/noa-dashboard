...
const phaseDefs = [
  { id: 1, slug: 'preprocessing', title: 'Agent 1 — Data Preprocessing', subtitle: '2,450 screened → 2,413 analytical • 73 engineered features', description: 'Clinical cohort ingestion, cleaning, and leakage-safe preprocessing for NOA micro-TESE prediction.', objectives: ['Ingest and quality-check source records', 'Construct analytical cohort', 'Engineer and validate feature set', 'Implement leakage-safe preprocessing'], deliverables: ['Leakage-safe preprocessing pipeline', 'Feature-engineered dataset', 'Data quality and missingness documentation'], iconKey: 'database', accent: '#0f6d8b' },
  { id: 2, slug: 'training', title: 'Agent 2 — Model Training', subtitle: '16 evaluated models • Best: LightGBM AUC 0.7327 ± 0.0057', description: 'Nested cross-validation model development and corrected benchmark reporting across 16 candidate algorithms.', objectives: ['Train and compare 16 model families', 'Apply nested CV with randomized search', 'Select corrected best model based on AUC and calibration profile'], deliverables: ['Ranked model-comparison table', 'Best-model metadata and hyperparameters', 'Reproducible training artifacts'], iconKey: 'cpu', accent: '#1c8a9c' },
  ...
  { id: 4, slug: 'xai', title: 'Agent 4 — Explainable AI', subtitle: 'SHAP + feature-importance synthesis on corrected LightGBM', description: 'Explainability outputs for global and local interpretation with clinically interpretable feature signals.', objectives: ['Generate SHAP global and local explanations', 'Compare FI and SHAP concordance', 'Summarize clinically interpretable behavior'], deliverables: ['SHAP summary outputs', 'Feature-importance plots', 'Clinician-facing interpretation notes'], iconKey: 'brain-circuit', accent: '#7c3aed' },
